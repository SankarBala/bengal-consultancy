...
@section('content')
    <div class="p-3">
        <form action="{{ route('admin.client-status.update', $clientStatus) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="row">
                <div class="col-25">
                ...
                <div class="col-75">
                    <input type="text" id="title" name="title" placeholder="Status title ..." value="{{$clientStatus->title}}">
                    @error('title')
            ...
            <div class="row">
                ...
                <div class="col-75">
                    <input type="text" id="description" name="description" placeholder="Status description ..." value="{{$clientStatus->description}}">
                    @error('description')
                        <p class="text-danger">{{ $message }}</p>
                    @enderror
                </div>
